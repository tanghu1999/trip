...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<!-- 订单用户信息表 tb_order_shipping-->
		<input type="hidden" name="orderShipping.receiverName" value="zs"/>
...
<script>
	...
	function save_Pay(num,obj){
        $("#payment-list li").find("div").removeClass("item-selected");
        //增加选中
			...
			<ul id="payment-list">
				...
				<li style="cursor: pointer;" onclick="save_Pay(2,this);">
					...
					<div class="payment-item item-selected online-payment "
						for="pay-method-4" payname="在线支付" payid="2">
						<b></b> 微信支付 <font class="whiteBarSpanClass hide"
                ...
                <li style="cursor: pointer;" onclick="save_Pay(3,this);">
                    ...
                    <div class="payment-item  online-payment "
                         for="pay-method-4" payname="在线支付" payid="3">
