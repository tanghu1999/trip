        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            <div class="cell p-checkbox"><input data-bind="cbid:1" class="checkbox" type="checkbox" name="checkItem" value="${cart.id}"></div>
...
<script type="text/javascript">
    ...
    $('#toggle-checkboxes_down').click(function () {
        $('input[name=checkItem]').prop('checked', $('#toggle-checkboxes_down').prop('checked'));
    });


    //点击删除按钮
    $('#remove-batch').click(function(){
        var itemIds = $('input[name=checkItem]');
        var ids = [];
